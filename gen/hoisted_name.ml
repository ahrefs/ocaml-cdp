...
let get_name_for_type_field ~type_id field =
...
let get_name_for_array_item ~type_id = Printf.sprintf "%s_item" (Naming.camel_to_snake type_id)
...
let get_name_for_item_field ~domain_type_names ~item_name field =
