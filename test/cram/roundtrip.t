...
encode/decode checks for every generated type.
  ...
  generated roundtrip_out.ml: 2 roundtrip checks, 1 enum checks, 0 skipped
  ...
  let () =
    check_enum "Demo.Mood" Cdp.Demo.mood_of_json Cdp.Demo.mood_to_json
      (fun (value : Cdp.Demo.mood) -> match value with Cdp.Demo.Other _ -> true | _known -> false)
      [ "happy"; "sad" ]
...
the recursion ends and the type is still checked.
  ...
  generated tree_out.ml: 1 roundtrip checks, 0 enum checks, 0 skipped
...
sample; it is skipped loudly instead of looping forever, and no check is emitted.
  ...
  generated chain_out.ml: 0 roundtrip checks, 0 enum checks, 1 skipped
